...
This model can be created/updated via spreadsheet import. See **[order-line](../imports/order-line.md)** for the column reference (valid headers, required fields, types, and conditional rules).
