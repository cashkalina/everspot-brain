...
| `partial-dates` | PartialDateCast `_year/_month/_day/_estimated`; calendar validity; "day requires month"; 2-digit-year ambiguity; interment.date NOT-NULL (operational; doi/dod else Jan-1-current-year default; doi holds the semantic date). | `dates`, `dob-dod`, `partial-dates`, `split-ymd-columns` · cleanse, assemble |
